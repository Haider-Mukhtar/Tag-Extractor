...
const Home = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black">
      {/* Notification */}
      <div
        className={`fixed top-4 right-4 bg-green-500 text-white px-4 py-2 rounded-lg shadow-lg flex items-center gap-2 transition-opacity duration-300 ${showCopyNotification ? 'opacity-100' : 'opacity-0 pointer-events-none'
          }`}
      >
